...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(ModItems.XAENON_SWORD.get());
        handheldItem(ModItems.XAENON_PICKAXE.get());
        handheldItem(ModItems.XAENON_SHOVEL.get());
        handheldItem(ModItems.XAENON_AXE.get());
        handheldItem(ModItems.XAENON_HOE.get());

        trimmedArmorItem(ModItems.XAENON_HELMET);
    ...
    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = Contentcraft.MOD_ID;
